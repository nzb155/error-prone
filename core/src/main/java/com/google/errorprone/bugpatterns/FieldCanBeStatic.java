...
public final class FieldCanBeStatic extends BugChecker implements VariableTreeMatcher {
  ...
  private static final Matcher<ExpressionTree> PURE_METHODS =
      anyOf(
          ...
          staticMethod().onClass("java.time.Instant"),
          staticMethod().onClass("java.time.LocalDate"),
          staticMethod().onClass("java.time.LocalDateTime"),
          staticMethod().onClass("java.time.LocalTime"),
          staticMethod().onClass("java.time.MonthDay"),
          staticMethod().onClass("java.time.OffsetDateTime"),
          staticMethod().onClass("java.time.OffsetTime"),
          ...
          staticMethod().onClass("java.time.ZonedDateTime"),
